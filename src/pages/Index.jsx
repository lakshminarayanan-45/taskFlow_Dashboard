  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <main className="container mx-auto px-4 py-12 md:py-20">
        ...
        {/* Features */}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-20 max-w-4xl mx-auto">
          ...
          <div className="p-4 md:p-6 rounded-xl bg-card border border-border sm:col-span-2 md:col-span-1">
            <div className="h-10 w-10 md:h-12 md:w-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
